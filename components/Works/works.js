...
const Work = () => {
  return (
    <section id="works">
      ...
      <span className='worksDesc'>I Take pride in playing attention to the smallest details and makin sure that my work is perfect. I am excited to bring my skils and experience to help business achieve their goals and create a strong online presence.</span>
      ...
      <buttom className="workBtn">See More</buttom>
    </section>
  )
}
